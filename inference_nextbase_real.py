...
# Add potential paths for Quixer module
sys.path.append(os.path.abspath("Quixer_tmp"))
sys.path.append(os.path.abspath("Quixer"))
...
def plot_results(y_true, y_pred):
    ...
    plt.savefig('nextbase_confusion_matrix_real.png')
    print("Saved nextbase_confusion_matrix_real.png")
